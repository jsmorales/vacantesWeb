<!-- Codigo para poder usar jstl en html
hay que entrar en las propiedades del proyecto y agregar la libreria
jstl 1.2.1, esto para poder usar el for each en la lista de resultados
del servlet siteController-->
    ...
    <div class="container">
     ...
     <!-- Example row of columns -->
      <div class="row">
        ...
        <c:forEach items="${resultado}" var="vacante" varStatus="status">
